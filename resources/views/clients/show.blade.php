    ...
    <div class="row">
        <div class="col-lg-4 pb-5">
            ...
            <div class="author-card pb-3">
                <div class="author-card-cover position-relative" style="background-image: url(https://bootdey.com/img/Content/flores-amarillas-wallpaper.jpeg); width: 103%; height: 50px;">
                    <a class="btn btn-style-1 btn-white btn-sm position-absolute" style="top: 10px; right: 10px;" href="#" data-toggle="tooltip" title="You currently have 290 Reward points to spend">
                        <i class="fa fa-award text-md"></i>&nbsp;290 points
                    </a>
                </div>
                <div class="author-card-profile">
                    <div class="author-card-avatar">
                        <img src="https://bootdey.com/img/Content/avatar/avatar1.png" width="103%" height="300px" alt="Daniel Adams">
            ...
            <div class="wizard">
                <nav class="list-group list-group-flush">
                    ...
                    <a class="list-group-item" href="https://www.bootdey.com/snippets/view/bs4-profile-settings-page" target="__blank">
